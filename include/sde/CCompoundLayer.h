// CCompoundLayer.h: interface for the CCompoundLayer class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CCOMPOUNDLAYER_H__778FFFA5_3D45_4D83_8F15_72B8C00A9BC3__INCLUDED_)
#define AFX_CCOMPOUNDLAYER_H__778FFFA5_3D45_4D83_8F15_72B8C00A9BC3__INCLUDED_
...
class __declspec(dllexport) CCompoundLayer  : public CLayer
{
public:
	CCompoundLayer(CNaviMap* ownerNaviMap, LAYER layerID, jmeta * pFieldsInfo);
	~CCompoundLayer();
...
#endif // !defined(AFX_CCOMPOUNDLAYER_H__778FFFA5_3D45_4D83_8F15_72B8C00A9BC3__INCLUDED_)
